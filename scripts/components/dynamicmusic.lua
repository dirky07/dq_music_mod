...
local SEASON_BUSY_MUSIC =
{
	day =
	{
		autumn = "music_mod/music_autumn/day",
		winter = "music_mod/music_winter/day",
		spring = "music_mod/music_spring/day",
		summer = "music_mod/music_summer/day",
	},
	dusk =
	{
		autumn = "music_mod/music_autumn/dusk",
		winter = "music_mod/music_winter/dusk",
		spring = "music_mod/music_spring/dusk",
		summer = "music_mod/music_summer/dusk",
	},
	night = 
	{
		autumn = "music_mod/music_autumn/night",
        winter = "music_mod/music_winter/night",
        spring = "music_mod/music_spring/night",
        summer = "music_mod/music_summer/night",
	},
}

local SEASON_EPICFIGHT_MUSIC =
{
    autumn = "music_mod/music_epicfight",
    winter = "music_mod/music_epicfight_winter",
    spring = "music_mod/music_epicfight_spring",
    summer = "music_mod/music_epicfight_summer",
}

local SEASON_DANGER_MUSIC =
{
    autumn = "music_mod/music_danger",
    winter = "music_mod/music_danger_winter",
    spring = "music_mod/music_danger_spring",
    summer = "music_mod/music_danger_summer",
}
    ...
    elseif _soundemitter ~= nil and _dangertask == nil and not _stingeractive and (continuous_mode or _extendtime == 0 or GetTime() >= _extendtime) and _isenabled then
        if _isbusydirty then
            ...
            _soundemitter:PlaySound(
                (_isruin and "music_mod/music_work_ruins") or
                (_iscave and "music_mod/music_work_cave") or
    ...
    elseif _isenabled then
	   ...
	   -- Check if music for season exists
        ...
        _soundemitter:PlaySound(
            ...
            and ((_isruin and "music_mod/music_epicfight_ruins") or
                (_iscave and "music_mod/music_epicfight_cave") or
                (SEASON_EPICFIGHT_MUSIC[season]))
            or ((_isruin and "music_mod/music_danger_ruins") or
                (_iscave and "music_mod/music_danger_cave") or
...
local function OnPhase(inst, phase)
    ...
    if _isday then
        _soundemitter:PlaySound("music_mod/music_dawn_stinger")
		if continuous_mode then
			_stingeractive = true
		end
    elseif phase == "dusk" then
        _soundemitter:PlaySound("music_mod/music_dusk_stinger")
		if continuous_mode then
			_stingeractive = true
		end
    end
